        ...
        <form action="{{route('productos.update',['producto'=>$producto])}}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="row g-4">
                    ...
                    <!---Fecha de temporada---->
                    <div class="col-md-6">
                        <label for="fecha_vencimiento" class="form-label">Fecha de temporada:</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="stock" id="stock" class="form-control" value="{{ old('stock',$producto->stock) }}" min="0">
                        @error('stock')
                        <small class="text-danger">{{ '*' . $message }}</small>
                        @enderror
                    </div>
