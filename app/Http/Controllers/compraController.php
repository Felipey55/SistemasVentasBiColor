...
class CompraController extends Controller
{
    ...
    public function destroy(string $id)
    {
        try {
            ...
            // Encuentra la compra y elimina sus relaciones con productos en la tabla intermedia, si las tiene
            $compra = Compra::findOrFail($id);

            // Elimina las relaciones en la tabla intermedia (compra_producto)
            $compra->productos()->detach();

            // Elimina el registro de la compra
            $compra->delete();
